...
namespace WebThamMyVien.Repository
{
    public class InvoiceRepository : IInvoiceRepository
    {
		...
		public async Task<ICollection<InvoiceDto>> GetAllInvoiceByType(int id)
		{
			var apiUrl = $"{_apiUrl}/api/Invoice/InvoiceByType{id}"; // Điền đường dẫn API tại đây
		...
		public async Task<InvoiceDto> GetInvoiceFinal()
		{
			var apiUrl = $"{_apiUrl}/api/Invoice/Final"; // Điền đường dẫn API tại đây
